import sys
sys.path.append('C:/Users/User/Desktop/Sulaiha/Assignments/banking_system/Complete_banking_system')
...
while True:
    ...
    try:
        if choice == '1':
            ...
            customer = Customers(0, fname, lname, dob, email, phone, address)
